 <nav class="navbar  shadow-sm sticky-top  navbar-expand-lg navbar-light bg-white py-3">
     <div class="container px-5">
         <a class="navbar-brand" href="{{ route('home.index') }}"><span class="fw-bolder text-primary">Faruk
                 Ahmad</span></a>
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                 ...
                 <li class="nav-item"><a class="nav-link" href="{{ route('home.resume') }}">Resume</a></li>
